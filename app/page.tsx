  ...
  return (
    <main className="overflow-hidden bg-ink text-slate-100">
      ...
      <section id="work" className="relative mx-auto max-w-7xl px-6 py-24 sm:px-10 lg:px-12 lg:py-32">
        <div className="mb-14 flex flex-col justify-between gap-5 sm:flex-row sm:items-end"><div><p className="eyebrow">Selected work</p><h2 className="section-title">Robotics and<br />software projects.</h2></div><p className="max-w-sm text-sm leading-6 text-slate-400">Projects across autonomy, embedded control, computer vision, and collaborative product building.</p></div>
      ...
      <section id="skills" className="mx-auto max-w-7xl px-6 py-24 sm:px-10 lg:px-12 lg:py-28"><div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]"><div><p className="eyebrow">Skills</p><h2 className="section-title">Technical toolkit</h2></div><div><p className="eyebrow mb-4 text-amber">Core robotics stack</p><div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-5"><TechLogo icon={SiCplusplus} name="C++" color="text-[#76a9dc]" /><TechLogo icon={SiRos} name="ROS 2" color="text-cyan" /><TechLogo icon={SiPython} name="Python" color="text-[#ffd343]" /><TechLogo icon={SiLinux} name="Linux" color="text-white" /><TechLogo icon={SiRaspberrypi} name="Embedded" color="text-[#e15b7a]" /></div><div className="mt-6 grid gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 sm:grid-cols-2"><SkillGroup title="Robotics & autonomy" items="Gazebo, localization, EKF, LiDAR, IMU, odometry, path planning, controls" /><SkillGroup title="Embedded systems" items="Raspberry Pi, Pico / RP2040, microcontrollers, I²C, firmware, sensor integration" /></div><p className="eyebrow mb-4 mt-8 text-slate-500">Additional software</p><div className="flex flex-wrap gap-2"><ToolPill icon={SiDocker} name="Docker" /><ToolPill icon={SiGit} name="Git" /><ToolPill icon={SiTypescript} name="TypeScript" /><ToolPill icon={FaJava} name="Java" /><ToolPill icon={SiKotlin} name="Kotlin" /><ToolPill icon={SiRuby} name="Ruby" /><ToolPill icon={SiRubyonrails} name="Rails" /><ToolPill icon={SiFastapi} name="FastAPI" /></div></div></div></section>
...
function ToolPill({ icon: Icon, name }: { icon: IconType; name: string }) { return <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[.025] px-3.5 py-2 text-xs font-semibold text-slate-400 transition hover:border-white/25 hover:text-white"><Icon aria-hidden="true" className="text-sm" /><span>{name}</span></div>; }
